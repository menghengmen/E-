...
-(instancetype)init {
    ...
    if (self) {
        ...
        self.animationDuration = @1000;//默认动画时长为500毫秒
       ...
       //波形颜色
        self.colorsTheme =  @[@"#3aabf6",@"#3aabf6",@"#50c18d",@"#fd4800",@"#f1c6c5"];
       ...
       //这个波形上面那个圈圈
        self.markerRadius = @0;//折线连接点的半径长度,如果值设置为0,这样就相当于不显示了
